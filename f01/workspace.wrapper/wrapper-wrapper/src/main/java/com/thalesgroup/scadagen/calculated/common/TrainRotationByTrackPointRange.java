...
public abstract class TrainRotationByTrackPointRange extends SCSStatusComputer implements SGSymbol_i {
	...
	public void loadCnf() {
		...
		logger = LoggerFactory.getLogger(TrainRotationByTrackPointRange.class.getName());
	...
	public AttributeClientAbstract<?> compute(OperatorOpmInfo operatorOpmInfo, String entityId,
		...
		logger.debug("compute rotation from trackIDAttName[{}] trackPointAttName[{}] directionAttName[{}]", new Object[]{trackIDAttName, trackPointAttName, directionAttName});
