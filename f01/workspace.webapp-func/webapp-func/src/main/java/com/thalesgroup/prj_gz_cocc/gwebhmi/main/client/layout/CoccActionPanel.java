...
import com.thalesgroup.prj_gz_cocc.gwebhmi.main.client.panels.CoccEquipmentTreePanel;
import com.thalesgroup.prj_gz_cocc.gwebhmi.main.client.panels.CoccInfoCommandTabPanel;
 ...
 * commands.
 */
public class CoccActionPanel extends ResizeComposite implements IClientLifeCycle {

    /**
     * Bus used for events exchanged between widgets of this {@link CoccActionPanel}
     */
    private final EventBus actionPanelEventBus_;

    /**
     * Identifier of the image contained within this {@link CoccActionPanel}
     */
     ...
     */
    private CoccSituationViewPanel situationViewPanel_;
     ...
     */
    private CoccEquipmentTreePanel entityTreePanel_;

    /**
     * Application bus into which {@link CoccActionPanel}'s events are forwarded
     */
     ...
     * Constructor.
     *
     * @param imageId identifier of the image contained within this {@link CoccActionPanel}
     * @param eventBus application bus into which {@link CoccActionPanel}'s events are forwarded
     */
    public CoccActionPanel(final String imageId, final EventBus eventBus) {
    ...
    private void addSituationViewPanel() {
    	situationViewPanel_ = new CoccSituationViewPanel(imageId_, appEventBus_);
    ...
    private void addObjectTreePanel() {
    	...
    	entityTreePanel_ = new CoccEquipmentTreePanel(treeId, appEventBus_);
    ...
    /**
     * Return the identifier of the image contained within this {@link CoccActionPanel}.
     *
     * @return the identifier of the image contained within this {@link CoccActionPanel}
     */
