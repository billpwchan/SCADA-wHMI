...
export class DbmService {
  ...
  public dbmItem = this.dbmSource.asObservable();
    ...
    this.httpClient.get(
      ...
      .subscribe(
        (res: any[]) => {
          ...
          const json = res;
          const dbvalue = json[CommonSettings.STR_RESPONSE][DbmSettings.STR_ATTR_DBVALUE];
    ...
    this.httpClient.get(
      ...
      .subscribe(
        (res: any[]) => {
          ...
          const dbvalue = res[CommonSettings.STR_RESPONSE][DbmSettings.STR_ATTR_DBVALUE];
          console.log(this.c, f, 'dbvalue', dbvalue);
          if ( null != dbvalue ) {
    ...
    this.httpClient.get(
      ...
      .subscribe(
        (res: any[]) => {
          ...
          const formulas: string[] = res[CommonSettings.STR_RESPONSE][DbmSettings.STR_FORMULAS];
  ...
  retriveClassId(connAddr: string, univname: string): void {
    ...
    this.httpClient.get(
      ...
      .subscribe(
        (res: any[]) => {
          console.log(this.c, f, res);
          const classId = res[CommonSettings.STR_RESPONSE][DbmSettings.STR_ATTR_CLASSID];
