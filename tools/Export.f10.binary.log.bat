...
SET _F10_SRC_POINTSELECT_ZIP=scadagen-f10-pointSelect*.zip
SET _F10_POINTSELECT_ZIP=scadagen-f10-pointSelect.zip
ECHO _F10_POINTSELECT=%_F10_POINTSELECT% _F10_SRC_POINTSELECT_ZIP=%_F10_SRC_POINTSELECT_ZIP% _F10_POINTSELECT_ZIP=%_F10_POINTSELECT_ZIP%
...
COPY %_F10_POINTSELECT%\%_F10_SRC_POINTSELECT_ZIP% %_folder%\
MOVE %_folder%\%_F10_SRC_POINTSELECT_ZIP% %_folder%\%_F10_POINTSELECT_ZIP%
