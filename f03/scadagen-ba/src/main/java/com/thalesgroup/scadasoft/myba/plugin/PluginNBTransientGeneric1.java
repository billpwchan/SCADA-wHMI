...
public class PluginNBTransientGeneric1 extends PluginNBTransientGenericAbstract {
	
	public static final String entityClassNamePropertyKey = PluginNBTransientGeneric1.class.getName() + PluginNBTransientGenericAbstract.entityClassNameStr;
	public static final String fromExpressionPropertyKey = PluginNBTransientGeneric1.class.getName() + PluginNBTransientGenericAbstract.fromExpressionStr;
	public static final String topicExpressionPropertyKey = PluginNBTransientGeneric1.class.getName() + PluginNBTransientGenericAbstract.topicExpressionStr;

	public PluginNBTransientGeneric1(IConfigTransient configPlugin,
		...
		pluginId = PluginNBTransientGeneric1.class.getName();
	}

	public PluginNBTransientGeneric1(IConfiguration configuration, IDataHelper dataHelper,
