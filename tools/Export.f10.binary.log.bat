...
SET _F10_POINTSELECT="%SOURCE_BASE_HOME%\f10\pointSelect"
SET _F10_TMS="%SOURCE_BASE_HOME%\f10\timeSchedule"

ECHO _F10_AUTOLOGOUT=%_F10_AUTOLOGOUT%
ECHO _F10_OPM=%_F10_OPM%
ECHO _F10_TIMESCHEDULE=%_F10_TIMESCHEDULE%
ECHO _F10_POINTSELECT=%_F10_POINTSELECT%
ECHO _F10_TMS=%_F10_TMS%
...
COPY %_F10_POINTSELECT%\%_F10_POINTSELECT_ZIP% %_folder%\%_F10_POINTSELECT_ZIP%
COPY %_F10_TMS%\%_F10_TMS_ZIP% %_folder%\%_F10_TMS_ZIP%
