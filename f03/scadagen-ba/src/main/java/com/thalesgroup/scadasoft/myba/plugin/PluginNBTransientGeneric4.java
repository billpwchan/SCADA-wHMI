...
public class PluginNBTransientGeneric4 extends PluginNBTransientGenericAbstract {

	public static final String entityClassNamePropertyKey = PluginNBTransientGeneric4.class.getName() + PluginNBTransientGenericAbstract.entityClassNameStr;
	public static final String fromExpressionPropertyKey = PluginNBTransientGeneric4.class.getName() + PluginNBTransientGenericAbstract.fromExpressionStr;
	public static final String topicExpressionPropertyKey = PluginNBTransientGeneric4.class.getName() + PluginNBTransientGenericAbstract.topicExpressionStr;

	public PluginNBTransientGeneric4(IConfigTransient configPlugin,
		...
		pluginId = PluginNBTransientGeneric4.class.getName();
	}

	public PluginNBTransientGeneric4(IConfiguration configuration, IDataHelper dataHelper,
