...
public class SCIsource extends AttributeComputer {
	/**
	...
	static public String computeArgs(TreeWalker walker, String att) {
	    ...
	    */
	    ...
	    while (childIter.hasNext()) {
	    	...
	    	if ("sac".equalsIgnoreCase(childName)) indicDac = childName ;
	    	else if ("sco".equalsIgnoreCase(childName)) indicDco = childName ;
	    	else if ("sfo".equalsIgnoreCase(childName)) indicDfo = childName ;
	    	else if ("ses".equalsIgnoreCase(childName)) indicDes = childName ;
	    }
