...
import com.thalesgroup.scadasoft.gwebhmi.security.client.CookieUtil;
import com.thalesgroup.scadasoft.gwebhmi.security.client.CookieUtil.DualScreenChoice;

public class CoccLoginPanel extends Composite{
    ...
    public interface LoginCallback {
         ...
         * @param isDualScreen dual screen mode?
         */
     ...
     * Constructor.
     *
     * @param actionUrl Url to which the login form is posted
     */
    public CoccLoginPanel(final String actionUrl) {
        this(actionUrl, true);
    }
     ...
     * Constructor.
     *
     * @param handleErrorMsg if true the login panel display message according to
     *            {@code Constants.AUTH_ERR_PARAM_NAME} url parameter.
     */
    public CoccLoginPanel(final boolean handleErrorMsg) {
     ...
     *            {@code Constants.AUTH_ERR_PARAM_NAME} url parameter.
     */
    public CoccLoginPanel(final String actionUrl, final boolean handleErrorMsg) {
     ...
     * @param password password
     * @param dualScreen select dual screen mode
     */
    @BenchmarkAnnotation
    ...
    protected void onLoad() {
        ...
        if (choice != null && DualScreenChoice.isDualScreen(choice)) {
            dualScreenCheckBox_.setValue(true);
        }
        else {
            dualScreenCheckBox_.setValue(false);
        }
