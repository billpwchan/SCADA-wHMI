...
//            	
//            	s_logger.error("checkEntitiesAttribute entities_.toString()["+entities_.toString()+"]");
//            	
...
//	}    
    ...
    private Set<HashMap<String, String>> getEntitieSet () {
    	...
    	s_logger.warn(LOG_PREFIX+"selected filter");
	    ...
	    for ( EntityClient ec : entities_ ) {
	    	...
	    	for ( String attributeName : ec.attributeNames() ) {
	    		s_logger.warn(LOG_PREFIX+"attributeName["+attributeName+"] value[" + ec.getAttribute(attributeName).getValue().toString() + "]");	
...
//    }
    ...
    class CallImageCommand implements Command {
        ...
        public void execute() {
            ...
            EntityClient entity = entities_.iterator().next();
            s_logger.error("CallImageCommand Command entity.toString()["+entity.toString()+"]");
