...
public class PluginNBTransientGeneric8 extends PluginNBTransientGenericAbstract {

	public static final String entityClassNamePropertyKey = PluginNBTransientGeneric8.class.getName() + PluginNBTransientGenericAbstract.entityClassNameStr;
	public static final String fromExpressionPropertyKey = PluginNBTransientGeneric8.class.getName() + PluginNBTransientGenericAbstract.fromExpressionStr;
	public static final String topicExpressionPropertyKey = PluginNBTransientGeneric8.class.getName() + PluginNBTransientGenericAbstract.topicExpressionStr;

	public PluginNBTransientGeneric8(IConfigTransient configPlugin,
		...
		pluginId = PluginNBTransientGeneric8.class.getName();
	}

	public PluginNBTransientGeneric8(IConfiguration configuration, IDataHelper dataHelper,
