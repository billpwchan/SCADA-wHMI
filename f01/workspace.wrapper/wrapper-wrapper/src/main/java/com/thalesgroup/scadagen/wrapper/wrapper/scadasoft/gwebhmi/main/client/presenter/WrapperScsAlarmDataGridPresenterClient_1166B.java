 ...
 */
public class WrapperScsAlarmDataGridPresenterClient_1166B extends AlarmDataGridPresenterClient {

    /**
     * Used to know which entities are selected in the view
     */
    private ScsGenericDataGridView_1166B view_;
     ...
     *            the event bus.
     */
    public WrapperScsAlarmDataGridPresenterClient_1166B(String configurationId, ScsGenericDataGridView_1166B view, EventBus eventBus, Set<FilterSetEvent> filterSet) {
