...
public class TrainPositionByTrackPointRange extends SCSStatusComputer implements SGSymbol_i {

	private final Logger logger = LoggerFactory.getLogger(TrainPositionByTrackPointRange.class.getName());
	...
	public TrainPositionByTrackPointRange() {
