...
public class PluginNBTransientGeneric3 extends PluginNBTransientGenericAbstract {

	public static final String entityClassNamePropertyKey = PluginNBTransientGeneric3.class.getName() + PluginNBTransientGenericAbstract.entityClassNameStr;
	public static final String fromExpressionPropertyKey = PluginNBTransientGeneric3.class.getName() + PluginNBTransientGenericAbstract.fromExpressionStr;
	public static final String topicExpressionPropertyKey = PluginNBTransientGeneric3.class.getName() + PluginNBTransientGenericAbstract.topicExpressionStr;

	public PluginNBTransientGeneric3(IConfigTransient configPlugin,
		...
		pluginId = PluginNBTransientGeneric3.class.getName();
	}

	public PluginNBTransientGeneric3(IConfiguration configuration, IDataHelper dataHelper,
