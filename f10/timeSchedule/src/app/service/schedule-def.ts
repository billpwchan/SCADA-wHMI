export class ScheduleDef {
    ...
    public static SCHEDULE_EQT_LABEL_COL = 5;
    public static SCHEDULE_EQT_ALIAS_COL = 6;
    public static SCHEDULE_EQT_POINT_ATT_COL = 7;
    public static SCHEDULE_EQT_TARGET_STATE = 8;
    public static SCHEDULE_TABLE_HEADER = 'sch_table';
    public static SCHEDULE_TASK_HEADER = 'sch_task';
