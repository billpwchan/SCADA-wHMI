...
public class PluginNBTransientGeneric6 extends PluginNBTransientGenericAbstract {

	public static final String entityClassNamePropertyKey = PluginNBTransientGeneric6.class.getName() + PluginNBTransientGenericAbstract.entityClassNameStr;
	public static final String fromExpressionPropertyKey = PluginNBTransientGeneric6.class.getName() + PluginNBTransientGenericAbstract.fromExpressionStr;
	public static final String topicExpressionPropertyKey = PluginNBTransientGeneric6.class.getName() + PluginNBTransientGenericAbstract.topicExpressionStr;

	public PluginNBTransientGeneric6(IConfigTransient configPlugin,
		...
		pluginId = PluginNBTransientGeneric6.class.getName();
	}

	public PluginNBTransientGeneric6(IConfiguration configuration, IDataHelper dataHelper,
