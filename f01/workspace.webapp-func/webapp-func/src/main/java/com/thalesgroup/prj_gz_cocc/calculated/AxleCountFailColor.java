...
public class AxleCountFailColor implements StatusComputer {
	...
	public AttributeClientAbstract<?> compute(OperatorOpmInfo operatorOpmInfo, String entityId,
		...
		IntAttribute att = (IntAttribute) inputStatusByName.get(FAULT);
		String color = "white";
		if (att != null) {
			if (att.getValue() == 1) {
				color = "red";
	...
	public String getComputerId() {
		return AxleCountFailColor.class.getName();
	}
