...
public class ReadPropTest {
	...
	public void testReadBoolean() {
		...
		logger.debug(className, function, "name[{}] result[{}]", boolean_test1, boolean_testresult1);
		...
		logger.debug(className, function, "name[{}] result[{}]", boolean_test2, boolean_testresult2);
		...
		logger.debug(className, function, "name[{}] result[{}]", boolean_test3, boolean_testresult3);
		...
		logger.debug(className, function, "name[{}] result[{}]", boolean_test4, boolean_testresult4);
		
		logger.debug(className, function, "Testing [{}] [{}] End", className, targetFunction);
	}
	...
	public void testReadInt() {
		...
		logger.debug(className, function, "name[{}] result[{}]", int_test1, int_testresult1);
		...
		logger.debug(className, function, "name[{}] result[{}]", int_test2, int_testresult2);
		...
		logger.debug(className, function, "name[{}] result[{}]", int_test3, int_testresult3);
	...
	public void testReadString() {
		...
		logger.debug(className, function, "name[{}] result[{}]", string_test1, string_testresult1);
...
//		
//		logger.debug(className, function, "name[{}] result[{}]", string_test2, string_testresult2);
