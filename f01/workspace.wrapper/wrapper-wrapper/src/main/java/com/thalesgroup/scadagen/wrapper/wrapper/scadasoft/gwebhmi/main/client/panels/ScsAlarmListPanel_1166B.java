...
import com.thalesgroup.scadagen.wrapper.wrapper.scadasoft.gwebhmi.main.client.presenter.WrapperScsAlarmDataGridPresenterClient_1166B;
import com.thalesgroup.scadagen.wrapper.wrapper.scadasoft.gwebhmi.main.client.view.ScsGenericDataGridView_1166B;
/**
 * A widget displaying an alarm list panel.
 */
public class ScsAlarmListPanel_1166B extends ResizeComposite
     ...
     */
    private WrapperScsAlarmDataGridPresenterClient_1166B gridPresenter_;
...
//    private final boolean withCaption_;
     ...
     */
    private ScsGenericDataGridView_1166B gridView_;
...
//    private static final String DICTIONATY_CAPTION_SUFFIX = "_caption";
     ...
     */
    public ScsAlarmListPanel_1166B(final EventBus eventBus, String listConfigId, boolean withAction, boolean withCaption, boolean withAck, Set<FilterSetEvent> filterSet) {
...
//            gridPresenter_.setMenu(contextMenu_);
            ...
            s_logger.error(ScsAlarmListPanel_1166B.class.getName()
...
//        containerPanel.addNorth(actionPanel, actionHeight);
    ...
    private void initDataGridView() {
        gridView_ = new ScsGenericDataGridView_1166B();
...
//    }
	...
	private static Logger logger = Logger.getLogger(ScsAlarmListPanel_1166B.class.getName());
    @Override
