...
public class UIControlPriorityReservation implements UIControlPriority_i {
	...
	public static UIControlPriority_i getInstance() {
		if(null==instance) instance = new UIControlPriorityReservation();
		return instance;
	}
	private UIControlPriorityReservation() {}
