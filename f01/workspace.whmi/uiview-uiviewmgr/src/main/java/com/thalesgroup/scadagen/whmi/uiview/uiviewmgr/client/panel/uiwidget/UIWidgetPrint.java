			...
			if ( null != widget ) {
				...
				if ( null != element ) {
					...
					if ( element.equals(strPrint) ) {
						...
						action.setParameter(ViewAttribute.Operation.toString(), PrintViewEvent.Print.toString());
						action.setParameter(ViewAttribute.OperationString1.toString(), strViewOnly);
