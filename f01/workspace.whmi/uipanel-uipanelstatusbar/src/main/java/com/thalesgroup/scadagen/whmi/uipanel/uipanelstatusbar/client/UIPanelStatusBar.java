...
public class UIPanelStatusBar implements UIPanel_i {

	private static Logger logger = Logger.getLogger(UIPanelStatusBar.class.getName());
	
	private String strUIPanelStatusBar					= "UIPanelStatusBar.xml";
	...
	private UIPanelGeneric uiScreenGeneric =  null;
	...
	public ComplexPanel getMainPanel(UINameCard uiNameCard){
		...
		uiScreenGeneric = new UIPanelGeneric();
		uiScreenGeneric.init(strUIPanelStatusBar);
		ComplexPanel complexPanel = uiScreenGeneric.getMainPanel(this.uiNameCard);
