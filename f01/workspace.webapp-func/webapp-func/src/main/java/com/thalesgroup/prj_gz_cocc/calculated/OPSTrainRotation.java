...
public class OPSTrainRotation implements StatusComputer {

//	private static final ClientLogger s_logger = ClientLogger.getClientLogger();
	private static final Logger s_logger = LoggerFactory.getLogger(OPSTrainRotation.class.getName());
     ...
     */
    public OPSTrainRotation() throws HypervisorException {
	...
	public AttributeClientAbstract<?> compute(OperatorOpmInfo operatorOpmInfo, String entityId,
		...
		s_logger.debug("*** OPSTrainRotation: compute *** " + entityId);
        ...
        if (trackAttribute != null ) { 
        	...
        	if (rotation != null) {
        		s_logger.debug("*** OPSTrainRotation: rotation for " + trackAttribute.getValue() + " " + rotation.toString());
        		attribute.setValue(rotation);
        	} else {
        		s_logger.debug("*** OPSTrainRotation: rotation not found for " + trackAttribute.getValue());
    ...
    public String getComputerId() {
        return OPSTrainRotation.class.getName();
    }
