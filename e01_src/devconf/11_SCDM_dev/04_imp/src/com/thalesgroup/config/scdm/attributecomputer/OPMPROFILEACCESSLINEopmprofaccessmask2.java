...
/******************************************************************************/
/*  FILE  : OPMPROFILEACCESSLINEopmprofaccessmask2.java                                   */
/*----------------------------------------------------------------------------*/
/*  COMPANY  : THALES IS                                                      */
...
/******************************************************************************/
public class OPMPROFILEACCESSLINEopmprofaccessmask2 extends AttributeComputer {
	/** 
	 * name of the mandatory link to compute
	 */
	final static private String link = "link_OmpActionMode2";
