...
public class AppEventsHandler implements NavigationActivationHandler, IClientLifeCycle, SelectionHandler<Integer>,
        CloseHandler<String>, OpenSituationViewEventHandler {
    ...
    public void onSelection(final SelectionEvent<Integer> event) {
        ...
        if (event.getSelectedItem() != null) {
            ...
            if (navId != null) {
                AppUtils.EVENT_BUS.fireEventFromSource(new NavigationSelectionEvent(navId, null, null), m_panelsContainer);
            } else {
                AppUtils.EVENT_BUS.fireEventFromSource(new NavigationSelectionEvent(null, null, null), m_panelsContainer);
            }
        }
    }
    ...
    public void onSelectionChange(OpenSituationViewEvent event) {
        ...
        if (m_appPanel.isMobileScreen()) {
            ...
            NavigationActivationEvent navEvent = new NavigationActivationEvent(event.getSituationViewId(), null, null);
