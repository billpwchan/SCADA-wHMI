...
/******************************************************************************/
public class UCS_TYPEcurrentdate extends AttributeComputer {

	@Override
	public String compute(TreeWalker walker, ComputeContext context) {
		String currentDate = "EVAL([.currentDIValue],TO_UNIXTIME(PUT({.currentDate},{.prevValueDate})))";
		return currentDate;
	}
}