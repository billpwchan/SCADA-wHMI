...
public class UIWidgetOPMVerifyControl extends UIWidget_i {
	
	private final String className = UIWidgetUtil.getClassSimpleName(UIWidgetOPMVerifyControl.class.getName());
				...
				if ( null != widget ) {
					...
					if ( null != element ) {
						...
						if ( "checkaccess".equals(element) ) {
							...
							String functionvalue	= uiWidgetGeneric.getWidgetValue("functionvalue");
							String locationvalue	= uiWidgetGeneric.getWidgetValue("locationvalue");
							String actionvalue		= uiWidgetGeneric.getWidgetValue("actionvalue");
							String modevalue		= uiWidgetGeneric.getWidgetValue("modevalue");
